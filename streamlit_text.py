...
# ============================================================
# INTERNAL PATHS — hidden from the user interface
# ============================================================
...
# ============================================================
# INTERNAL MODEL FEATURES — hidden from the user interface
# ============================================================
...
def generate_silicone_oil(
    ...
    result = {
        ...
        **counts,
        ...
        # Internal model descriptors — hidden from display
...
st.write(
    ...
    "After the structure is generated, run the ice-adhesion prediction in a second step."
)
